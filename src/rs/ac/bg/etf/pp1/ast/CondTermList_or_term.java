...
public class CondTermList_or_term extends CondTermList {

    private CondTermList CondTermList;
    private CondTerm CondTerm;

    public CondTermList_or_term (CondTermList CondTermList, CondTerm CondTerm) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondTermList_or_term(\n");
