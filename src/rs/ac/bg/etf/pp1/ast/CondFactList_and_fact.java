...
public class CondFactList_and_fact extends CondFactList {

    private CondFactList CondFactList;
    private CondFact CondFact;

    public CondFactList_and_fact (CondFactList CondFactList, CondFact CondFact) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondFactList_and_fact(\n");
